...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $sql = "INSERT INTO anggota (nama_lengkap, foto_profil, email, password, alamat, no_telepon) VALUES (?, ?, ?, ?, ?, ?)";
    ...
    <div class="card mb-4">
        <div class="card-body">
            <form method="post" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    <label for="foto_profil" name="foto_profil" class="form-label">Upload Foto Profil</label>
